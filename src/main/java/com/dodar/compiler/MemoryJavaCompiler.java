...
/**
 * 主类： Simple interface to Java compiler using JSR 199 Compiler API.
 */
public class MemoryJavaCompiler {
    ...
    private Map<String, byte[]> compile(final List<JavaFileObject> compUnits,
        ...
        JavaCompiler.CompilationTask task = tool.getTask(err, fileManager, diagnostics, options, null, compUnits);
